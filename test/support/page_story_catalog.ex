defmodule ObanPowertools.PageStoryCatalog do
  ...
  @acceptance_by_id %{
    "page-overview-all-quiet" => %{
      required_text: [
        "Overview",
        "No current follow-up identified",
        "Available evidence identifies no work that needs review."
      ],
      forbidden_text: @forbidden_copy,
      ordered_text: [
        "Overview",
        "Current attention",
      ...
      roles: [%{role: "heading", name: "Overview", level: 1, states: %{}}]
    },
    ...
    "page-overview-long-unicode" => %{
      ...
      forbidden_text: @forbidden_copy,
      ordered_text: ["Overview", "Current attention", "Needs Review — お客様通知"],
      roles: [%{role: "heading", name: "Overview", level: 1, states: %{}}]
    },
    "page-cron-selected-detail" => %{
      required_text: ["Cron", "nightly-notification-reconciliation", "Pause cron entry"],
      forbidden_text: @forbidden_copy,
      ordered_text: ["Cron", "Cron entries", "nightly-notification-reconciliation"],
      roles: [%{role: "heading", name: "Cron", level: 1, states: %{}}]
    },
    "page-cron-permission-denied" => %{
      required_text: [
        "Cron",
        "Permission: read-only.",
        "you do not have permission to preview or execute this Audited action."
      ],
      forbidden_text: @forbidden_copy,
      ordered_text: ["Cron", "Permission: read-only.", "Cron entries"],
      roles: [
        %{role: "heading", name: "Cron", level: 1, states: %{}},
        %{role: "button", name: "Pause cron entry", states: %{disabled: true}}
      ]
    },
    "page-cron-pause-confirmation" => %{
      required_text: [
        "Pause nightly-notification-reconciliation",
        "Future schedule claims stop. Work that is already running or enqueued is unaffected.",
        "The existing schedule and already-claimed work remain unchanged."
      ],
      forbidden_text: @forbidden_copy,
      ordered_text: ["Cron", "Pause nightly-notification-reconciliation", "Consequence"],
      roles: [
        %{role: "heading", name: "Cron", level: 1, states: %{}},
        %{
          role: "dialog",
          name: "Pause nightly-notification-reconciliation",
          states: %{}
        }
      ]
    },
    "page-cron-resume-confirmation" => %{
      required_text: [
        "Resume nightly-notification-reconciliation",
        "Future schedule claims continue. Missed work is not run retroactively.",
        "Only future schedule claims continue after this action."
      ],
      forbidden_text: @forbidden_copy,
      ordered_text: ["Cron", "Resume nightly-notification-reconciliation", "Consequence"],
      roles: [
        %{role: "heading", name: "Cron", level: 1, states: %{}},
        %{
          role: "dialog",
          name: "Resume nightly-notification-reconciliation",
          states: %{}
        }
      ]
    },
    "page-cron-run-now-confirmation" => %{
      required_text: [
        "Run nightly-notification-reconciliation now",
        "Powertools attempts a manual schedule-slot claim.",
        "A recorded slot claim does not prove that a job ran."
      ],
      forbidden_text: ["Job ran successfully" | @forbidden_copy],
      ordered_text: ["Cron", "Run nightly-notification-reconciliation now", "Consequence"],
      roles: [
        %{role: "heading", name: "Cron", level: 1, states: %{}},
        %{
          role: "dialog",
          name: "Run nightly-notification-reconciliation now",
          states: %{}
        }
      ]
    },
    "page-cron-expired-recovery" => %{
      required_text: [
        ...
        "Create a new preview before continuing.",
        "Create new preview"
      ],
      forbidden_text: @forbidden_copy,
      ordered_text: ["Cron", "Pause nightly-notification-reconciliation", "Create new preview"],
      roles: [
        %{role: "heading", name: "Cron", level: 1, states: %{}},
        %{role: "button", name: "Create new preview", states: %{}}
      ]
    },
    "page-cron-drifted-recovery" => %{
      ...
      forbidden_text: @forbidden_copy,
      ordered_text: ["Cron", "Resume nightly-notification-reconciliation", "Create new preview"],
      roles: [
        %{role: "heading", name: "Cron", level: 1, states: %{}},
        %{role: "button", name: "Create new preview", states: %{}}
      ]
    ...
    "page-cron-skipped-partial-recovery" => %{
      required_text: [
        "The manual schedule-slot claim was skipped.",
        "Create a new preview before trying again.",
        "Create new preview"
      ],
      forbidden_text: ["Job ran successfully" | @forbidden_copy],
      ordered_text: ["Cron", "Run nightly-notification-reconciliation now", "Create new preview"],
      roles: [
        %{role: "heading", name: "Cron", level: 1, states: %{}},
        %{role: "button", name: "Create new preview", states: %{}}
      ]
    ...
    "page-limiters-runnable-empty-current" => %{
      required_text: [
        "Limiters",
        "Current limiter state is ready for work.",
        "No current limiter condition prevents new reservations."
      ],
      forbidden_text: @forbidden_copy,
      ordered_text: [
        "Limiters",
      ...
      roles: [%{role: "heading", name: "Limiters", level: 1, states: %{}}]
    },
    ...
    "page-limiters-unavailable" => %{
      ...
      forbidden_text: @forbidden_copy,
      ordered_text: ["Limiters", "Limiter unavailable", "Data unavailable"],
      roles: [%{role: "heading", name: "Limiters", level: 1, states: %{}}]
    },
    "page-limiters-forensics-unavailable" => %{
      ...
      forbidden_text: ["Open forensic timeline" | @forbidden_copy],
      ordered_text: [
        "Limiters",
        "Current blockers",
        "Snapshot at block start",
    ...
    "page-audit-empty" => %{
      required_text: ["Audit", "No audit records recorded", "0 records · Page 1 of 1"],
      forbidden_text: @forbidden_copy,
      ordered_text: ["Audit", "Repair evidence retention", "Audit records"],
      roles: [%{role: "heading", name: "Audit", level: 1, states: %{}}]
    },
    "page-audit-filtered-boundary-page" => %{
      required_text: [
        "Records 21–40 of 41 · Page 2 of 3",
        "Resource type: limiter",
        "Limiter blocked"
      ],
      forbidden_text: @forbidden_copy,
      ordered_text: ["Audit", "Repair evidence retention", "Records 21–40 of 41"],
      roles: [%{role: "heading", name: "Audit", level: 1, states: %{}}]
    },
    "page-audit-selected-long-unicode" => %{
      required_text: [
        "Audit evidence",
        "Miyazaki Haruka — مرحبا",
        "Repair request recorded"
      ],
      forbidden_text: @forbidden_copy,
      ordered_text: ["Audit", "Repair evidence retention", "Audit evidence"],
      roles: [%{role: "heading", name: "Audit", level: 1, states: %{}}]
    },
  ...
  @stories Enum.map(@story_specs, fn story ->
             ...
             story
             |> Map.put(:acceptance, Map.fetch!(@acceptance_by_id, id))
             |> Map.put(:test_targets, %{
  ...
  defp phase80_stories do
    [
      ...
      phase80_story(
        ...
        ["Forensics", "Event log unavailable."]
      ),
      phase80_story(
