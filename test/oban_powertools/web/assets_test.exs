defmodule ObanPowertools.Web.AssetsTest do
  ...
  test "checked-in compiled assets include component and production page CSS plus scoped browser behavior" do
    ...
    for selector <- [
          ...
          ".obpt-root .obpt-batches-page",
          ".obpt-root .obpt-workflows-page",
          ".obpt-root .obpt-workflows-page__steps",
          ".obpt-root .obpt-workflows-page__step",
          ".obpt-root .obpt-lifeline-page",
          ".obpt-root .obpt-lifeline-page__metrics",
          ".obpt-root .obpt-lifeline-page__views",
          ".obpt-root .obpt-lifeline-page__detail",
    ...
    assert js =~ "[data-obpt-page-selection]"
    assert js =~ "syncPageSelection"
    assert js =~ "control.indeterminate = state === \"mixed\""
    assert js =~ "\"data-obpt-page-selection\""
