...
- [x] **Phase 44: Single-Job Actions** — Retry, cancel, discard on individual jobs through the full Lifeline preview/reason/audit pipeline (completed 2026-05-28)
- [x] **Phase 45: Bulk Operations** — Bulk retry/cancel/discard for a visible job selection with per-job result reporting (completed 2026-05-28)
...
**Plans**: 2 plans
  ...
  - [x] 45-01-PLAN.md — Checkbox selection UI + MapSet-backed selection state in JobsLive
  - [x] 45-02-PLAN.md — Bulk action bar/preview modal + per-job independent execute pipeline
...
| 44    | v1.5      | 2/2           | Complete    | 2026-05-28 |
| 45    | v1.5      | 2/2           | Complete    | 2026-05-28 |
