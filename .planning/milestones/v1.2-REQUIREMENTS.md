...
| Cross-product control-plane unification | Explicitly reserved for the later v1.3 milestone in `research/MILESTONE-ARC.md`. |
...
- Verified and shipped exactly as archived after the passed rerun audit on 2026-05-25.
- The failed 2026-05-25 milestone audit remains preserved separately as historical evidence at `.planning/v1.2-MILESTONE-AUDIT.md`.
- The canonical current milestone verdict at ship time is `.planning/milestones/v1.2-rerun-MILESTONE-AUDIT.md`.

---
*Requirements defined: 2026-05-23*
*Archived: 2026-05-25 after Phase 24-26 verification, traceability, and closeout hygiene repairs*
