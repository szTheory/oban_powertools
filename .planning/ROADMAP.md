...
- [ ] **Phase 64: Args/Meta Filtering & Programmatic Querying** - API and UI support for precise filtering of jobs by arguments and metadata
...
**Plans**: 2 plans
- [ ] 64-01-PLAN.md — Domain layer: Jobs filtering & Operator API
- [ ] 64-02-PLAN.md — Web layer: JobsLive filtering inputs
**UI hint**: yes
...
|-------|----------------|--------|-----------|
| 64. Args/Meta Filtering & Programmatic Querying | 0/2 | Not started | - |
